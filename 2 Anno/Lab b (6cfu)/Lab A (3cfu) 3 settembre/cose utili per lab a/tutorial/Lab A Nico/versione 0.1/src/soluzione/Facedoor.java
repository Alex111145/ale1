...
public class Facedoor {
	...
	public static boolean controllaArgomenti( String[] args ) {
		...
		if( args.length < 1 ) {
			System.out.println( "[ERRORE] Non e' stato passato alcun argomento." );
			return false;
		}
		...
		if( !file.exists() ) {
			...
			return false;//ERRORE IL FILE NON ESISTE //TODO SET AN ERROR LEVEL
		}
	...
	public static void importa( String nomefile ) {
		...
		if( mc == null ) {
			mc = new ManagerComandi( new ManagerEventi() );
		}
