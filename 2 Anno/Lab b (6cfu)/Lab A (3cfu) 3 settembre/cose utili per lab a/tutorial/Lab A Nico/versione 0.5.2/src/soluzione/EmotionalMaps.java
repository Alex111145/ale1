...
/**
 * Classe che gestisce il flusso di funzionamento principale del programma.
 * 
 * @author Simone 	Brenna 		732520
 * @author Nicolo 	Ferrari		732707
 * @author Luigi 	Mucciarone	732714
 * @author Luca 	Alberti		733096
 * 
 */
public class EmotionalMaps {
	...
	public static boolean controllaArgomenti( String[] args ) {
		...
		if( args.length < 1 ) {
			System.out.println( "[ERRORE] Non e' stato passato alcun argomento, inserire il path con il nome del file contenente i comndi." );
			return false;
		}
