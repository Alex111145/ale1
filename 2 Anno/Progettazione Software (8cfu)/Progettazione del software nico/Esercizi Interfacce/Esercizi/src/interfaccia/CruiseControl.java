 ...
 * @author NICO-TINA
 */
public class CruiseControl extends javax.swing.JFrame {
    
    int kmh = 40;
    

    /**
     * Creates new form CruiseControl
     */
    ...
    private void initComponents() {
        ...
        jTextField1.setFont(new java.awt.Font("Segoe WP Black", 1, 48)); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        jTextField1.setText(Integer.toString(kmh));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CruiseControl.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CruiseControl().setVisible(true);
            }
        });
    }
