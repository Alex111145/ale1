...
/**
 * Classe per la rappresentazione di eventi.
 * <p>
 * La classe ausiliaria <code>Evento</code> serve a gestire in modo piu' semplice i dati riguardanti un evento generato da Facedoor,
 * ovvero le foto scattate dagli utenti che fanno uso di Facedoor.
 * 
...
public class Evento {
	...
	private String timestamp;//ddmmyyyy
	private String id;
	private double x, y;
